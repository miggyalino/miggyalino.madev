...
const TechStack = () => {
  return (
    <div className="p-12 bg-gray-700 rounded-xl border-2">
      {/* <p className="text-white font-bold text-4xl mb-12">My Tech Stack</p> */}
      <div className="flex flex-col gap-10">
        <div>
          <p className="text-white text-4xl font-bold mb-4">Front End</p>
        ...
        <div>
          <p className="text-white text-4xl font-bold mb-4">Back End</p>
          <div className="flex gap-8 flex-wrap">
        ...
        <div>
          <p className="text-white text-4xl font-bold mb-4">Database</p>
          <div className="flex gap-8 flex-wrap">
